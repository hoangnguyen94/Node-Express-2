...
describe("POST /auth/login", function() {
  ...
  /**BUG: added test for check admin
  */
  ...
  test( "not allow  an invalid admin to log in", async function ()
  {
    const response = await request( app )
      .post( "/auth/login" )
      .send( {
...
describe("GET /users/[username]", function() {
  ...
  /**BUG: didn't check for querying non-existing user,
   * added test for non-existing user
   */
...
describe("PATCH /users/[username]", function() {
  ...
  //BUG: didn't test for a user try to update information
...
describe("DELETE /users/[username]", function() {
  ...
  /**BUG: didn't not filter out change request for admin fileds */
